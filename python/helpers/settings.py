...
def convert_out(settings: Settings) -> SettingsOutput:
    ...
    # Add RFC enabled toggle
    dev_fields.append(
        {
            "id": "rfc_enabled",
            "title": "Enable RFC",
            "description": "Enable Remote Function Calls to execute functions on a remote Agent Zero instance.",
            "type": "checkbox",
            "value": settings["rfc_enabled"],
        }
    )
    ...
    if runtime.is_development():
        ...
        #         "description": "Automatically create instance of A0 for RFCs using this instance's code base and, settings and .env.",
        #         "type": "text",
        ...
        dev_fields.append(
            {
                ...
                "description": "URL of A0 instance for remote function calls. Do not specify port here.",
                "type": "text",
        ...
        dev_fields.append(
            {
                "id": "rfc_port_http",
                "title": "RFC HTTP port",
                "description": "HTTP port for instance of A0.",
                "type": "text",
    ...
    tts_fields.append(
        {
            "id": "tts_enabled",
            "title": "Enable TTS",
            "description": "Enable text-to-speech for agent responses",
            "type": "switch",
    ...
    tts_fields.append(
        {
            "id": "tts_url",
            "title": "TTS API URL",
            "description": "OpenAI-compatible TTS API endpoint",
            "type": "text",
    ...
    tts_fields.append(
        {
            "id": "tts_model",
            "title": "TTS Model",
            "description": "TTS model to use (e.g. kokoro)",
            "type": "text",
    ...
    tts_fields.append(
        {
            "id": "tts_voice",
            "title": "Voice",
            "description": "Voice to use for TTS (e.g. bm_daniel)",
            "type": "text",
    ...
    tts_section: SettingsSection = {
        ...
        "description": "Text-to-speech settings for agent responses.",
        "fields": tts_fields,
        "tab": "agent",
    }
...
def _write_sensitive_settings(settings: Settings):
    ...
    # Save RFC_ENABLED setting to .env file
    dotenv.save_dotenv_value(dotenv.KEY_RFC_ENABLED, "ON" if settings["rfc_enabled"] else "OFF")
...
def get_default_settings() -> Settings:
    ...
    return Settings(
        ...
        rfc_enabled=dotenv.get_dotenv_value(dotenv.KEY_RFC_ENABLED, "OFF").upper() in ["ON", "ENABLED", "TRUE", "1"],
        rfc_auto_docker=True,
        rfc_url="localhost",
        rfc_password="",
        rfc_port_http=55080,
        stt_enabled=True,
        stt_url=dotenv.get_dotenv_value("STT_API_URL", "http://192.168.50.59:7000/v1/audio/transcriptions"),
        stt_model=dotenv.get_dotenv_value("STT_MODEL", "Systran/faster-whisper-medium"),
        stt_language="en",
        stt_silence_threshold=0.3,
        stt_silence_duration=1000,
        stt_waiting_timeout=2000,
        tts_enabled=True,
        tts_url=dotenv.get_dotenv_value("TTS_API_URL", "http://192.168.50.59:8880/v1/audio/speech"),
        tts_model=dotenv.get_dotenv_value("TTS_MODEL", "kokoro"),
        tts_voice=dotenv.get_dotenv_value("TTS_VOICE", "bm_daniel"),
        tts_speed=1.0,
        mcp_servers='{\n    "mcpServers": {}\n}',
...
def set_root_password(password: str):
    if not runtime.is_dockerized():
        raise Exception("root password can only be set in appropriate environments")
